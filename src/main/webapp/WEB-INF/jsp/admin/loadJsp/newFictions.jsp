...
<div class="pageDiv">
    <nav>
        <ul class="pagination">
            ...
            >
                <a  href="admin/fiction/list/new?start=0${page.param}" aria-label="Previous" >
            ...
            <li <c:if test="${!page.hasPrevious}">class="disabled"</c:if>
                <c:if test="${page.hasPrevious}">class="enable"</c:if>
            >
                <a  href="admin/fiction/list/new?start=${page.start-page.count}${page.param}" aria-label="Previous" >
                    <span aria-hidden="true">‹</span>
                </a>
            </li>
            ...
            <c:forEach begin="0" end="${page.totalPage-1}" varStatus="status">
                ...
                >
                    <a
                            href="admin/fiction/list/new?start=${status.index*page.count}${page.param}"
            ...
            >
                <a href="admin/fiction/list/new?start=${page.start+page.count}${page.param}" aria-label="Next">
                    <span aria-hidden="true">›</span>
                </a>
            </li>
            <li <c:if test="${!page.hasNext}">class="disabled"</c:if>
                <c:if test="${page.hasNext}">class="enable"</c:if>
            >
                <a href="admin/fiction/list/new?start=${page.last}${page.param}" aria-label="Next">
                    <span aria-hidden="true">»</span>
                </a>
            </li>
        </ul>
